    ...
    public UserBorrow() {
        ...
        btn1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                String sql1 = "select Price from book where BookId = " + i
                        + ";";
                String sql2 = "update book set IsBorrow = '无' where BookId = "
                        + i + ";";
                String sql22 ="UPDATE book SET Price=Price-1 where BookId =" + i +";";
                ...
                try {
                    ...
                    int bookNum = Integer.parseInt(s);
                    if (bookNum>0) {//如果没有借出
                        ...
                        stmt.executeUpdate(sql2);
                        JOptionPane.showMessageDialog(null, "该书籍库存不足");
                        dispose();
                    }
