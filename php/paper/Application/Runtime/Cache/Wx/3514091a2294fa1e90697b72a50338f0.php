		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4 col-md-offset-4">
                    ...
                    <!-- <?php echo U('Index/Login_check');?> -->
					<!-- Start Sign In Form -->
					<form action="Login_check" class="fh5co-form animate-box" data-animate-effect="fadeIn" method="post">
						<h2>信息绑定</h2>
						...
						<div class="form-group">
							<input type="submit" value="绑 定" class="btn btn-primary">
						</div>
					</form>
					<!-- END Sign In Form -->
