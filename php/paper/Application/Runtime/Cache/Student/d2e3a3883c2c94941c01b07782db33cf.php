...
<html lang="en">
  <head>
    ...
    <!-- Page Specific CSS -->
    <link rel="stylesheet" href="/Public/Student/css/morris-0.4.3.min.css">
  </head>
            ...
            <table id="table">
              ...
              <tbody>               
                  <tr>
                    ...
                    <td><?php if($studentInfo["topic"] == ''): ?>未选题<?php else: ?> <?php echo ($studentInfo["topic"]); endif; ?> </td>
                      <td><?php echo ($topic_state1); ?></td>
                      <td><?php echo ($topic_state2); ?></td>
                      <td><?php if($studentInfo["score1"] == -1): ?>成绩未录入<?php else: echo ($studentInfo["score1"]); endif; ?></td>
                      <td><?php if($studentInfo["score2"] == -1): ?>成绩未录入<?php else: echo ($studentInfo["score2"]); endif; ?></td>
                      <td><?php if($studentInfo["score3"] == -1): ?>成绩未录入<?php else: echo ($studentInfo["score3"]); endif; ?></td>
                      <td><?php if($studentInfo["score4"] == -1): ?>成绩未录入<?php else: echo ($studentInfo["score4"]); endif; ?></td>
                      <td><?php if($studentInfo["finally"] == -1): ?>成绩未录入<?php else: echo ($studentInfo["finally"]); endif; ?></td>
