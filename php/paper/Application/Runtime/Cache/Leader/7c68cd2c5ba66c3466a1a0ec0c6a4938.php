...
<html lang="en">
  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>审核题目</h1>
            <div class="alert alert-info alert-dismissable">修改审核状态</div>
          </div>
        </div><!-- /.row -->
        ...
        <div class="row">
            <div class="table-responsive">
              <table class="table table-bordered table-hover tablesorter">
                <thead>
                  <tr>
                    ...
                    <th>姓名</th>
                    <th>题目</th>
                    <th width="110px">审核状态</th>
                    <th width="180px">点击修改审核状态</th>
                  </tr>
                </thead>
                <tbody>
              ...
              <?php if($vo["topic_state2"] == 0): ?><td>未审批</td>
              <?php elseif($vo["topic_state2"] == 1): ?>
              <td>审核通过</td>
              <?php elseif($vo["topic_state2"] == 2): ?>
              <td>审核不通过</td><?php endif; ?>  
                  <td><a href="/index.php/Leader/Student/revisionreview/id/<?php echo ($vo["id"]); ?>/status/1">通过审核</a>|<a href="/index.php/Leader/Student/revisionreview/id/<?php echo ($vo["id"]); ?>/status/2">不通过审核</a></td> 
                  </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                </tbody>
              </table>
            </div>
               <div class="pages"  style="width:400px;margin: 0 auto;">
                        <?php echo ($fenye); ?>
                </div>
        </div><!-- /.row -->
      </div><!-- /.row -->
    ...
    <script src="/Public/Leader/js/common.js"></script>
  <!-- JavaScript -->
