              ...
              <table class="table table-bordered table-hover tablesorter">
                ...
                <tbody>
                  <?php if(is_array($students)): $i = 0; $__LIST__ = $students;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td>
                      <?php if($vo["ppt1"] != '' ): ?><a href="/index.php/Leader/Student/downloadfile/path/<?php echo ($vo["ppt1"]); ?>">下载</a>
                      <?php else: ?>
                      未上传<?php endif; ?>
                    </td>
                    <td>
                      <?php if($vo["report"] != '' ): ?><a href="/index.php/Leader/Student/downloadfile/path/<?php echo ($vo["report"]); ?>">下载</a>
                      <?php else: ?>
                      未上传<?php endif; ?>
                    </td>
                    <td>
                      <?php if($vo["ppt2"] != '' ): ?><a href="/index.php/Leader/Student/downloadfile/path/<?php echo ($vo["ppt2"]); ?>">下载</a>
                      <?php else: ?>
                      未上传<?php endif; ?>
                    </td>
                    <td>
                      <?php if($vo["paper"] != '' ): ?><a href="/index.php/Leader/Student/downloadfile/path/<?php echo ($vo["paper"]); ?>">下载</a>
                      <?php else: ?>
                      未上传<?php endif; ?>
                    </td>
