      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            ...
            <div class="alert alert-info alert-dismissable"><a class="btn btn-primary" href="<?php echo U('Student/graderule');?>">输入总分计算公式</a>

               <a class="btn btn-primary" href="<?php echo U('Student/getfinallygrade');?>">导出学生总成绩</a>
            ...
            <div class="table-responsive">
              ...
              <table class="table table-bordered table-hover tablesorter">
                ...
                <?php if(is_array($students)): $i = 0; $__LIST__ = $students;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php echo ($vo["score1"]); ?></td>

                    <td><?php echo ($vo["score2"]); ?></td>

                    <td><?php echo ($vo["score3"]); ?></td>

                    <td><?php echo ($vo["score4"]); ?></td>

                    <td><?php echo ($vo["finally"]); ?></td>

                  <?php if($vo["state"] == 1 or $vo["state"] == 0): ?><td>未选题</td>
