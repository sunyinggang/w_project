          ...
          <div class="col-lg-6">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-clock-o"></i> 修改密码</h3>
              </div>
...
<form method="post" class="form-horizontal" action="">
  <input type="hidden" name="id" value="<?php echo ($paper_teacher["id"]); ?>">

 
   <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">用户名</label>
    <div class="col-sm-5">
      <input type="username" class="form-control" id="username" name="username" value="<?php echo ($paper_teacher["name"]); ?>">
    </div>
  </div>
  <div class="form-group">
