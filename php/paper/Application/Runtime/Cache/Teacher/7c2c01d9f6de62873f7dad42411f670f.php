                    ...
                    <tbody>
                      <tbody>
                        ...
                        <td><?php echo ($vo["name"]); ?></td>
                          ...
                          <td><?php if($vo['topic_state1'] == 1): ?>审核通过
                             <?php elseif($vo['topic_state1'] == 0): ?>审核未通过
                             <?php elseif($vo['topic_state1'] == -1): ?>
                             未审核<?php endif; ?>
                        <td><div class="button-group"> <a class="button border-main" href="/index.php/Teacher/Examine/edit/id/<?php echo ($vo["id"]); ?>"> 审核</a>
                          </div></td>
