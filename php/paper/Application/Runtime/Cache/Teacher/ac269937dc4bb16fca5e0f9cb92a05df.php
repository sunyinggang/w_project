                  ...
                  <table class="table table-bordered table-hover table-striped tablesorter">
                    ...
                    <tbody>
                      <tbody>
                        ...
                        <td><div class="button-group"> <?php if($vo["ppt1"] != '' ): ?><div class="button-group"> <a class="button border-main" href="/index.php/Teacher/Index/downloadfile/path/<?php echo ($vo["ppt1"]); ?>">  下载</a><?php else: ?>未上传<?php endif; ?>
                         <!--  <a class="button border-main" href="/index.php/Teacher/Index/add/id/<?php echo ($vo["id"]); ?>"> 上传</a> -->
