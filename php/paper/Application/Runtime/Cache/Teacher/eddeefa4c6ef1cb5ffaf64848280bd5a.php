          ...
          <div class="col-lg-6">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-clock-o"></i> 上传开题成绩</h3>
              </div>
...
<form method="post" class="form-horizontal" action="">
 ...
 <div class="form-group">
   ...
   <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">指&nbsp;导&nbsp;老&nbsp;师</label>
    <div class="col-sm-5">
      <input type="score1" class="form-control" id="score1" name="score1">
    </div>
  </div>
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">答辩委员会</label>
    <div class="col-sm-5">
      <input type="score2" class="form-control" id="score2" name="score2">
    </div>
  </div>
  <div class="form-group">
