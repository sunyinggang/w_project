                  ...
                  <table class="table table-bordered table-hover table-striped tablesorter">
                    ...
                    <tbody>
                      <tbody>
                        ...
                        <td><div class="button-group"> <?php if($vo["paper"] != '' ): ?><div class="button-group"> <a class="button border-main" href="/index.php/Teacher/Paper/downloadfile/path/<?php echo ($vo["paper"]); ?>">  下载</a><?php else: ?>未上传<?php endif; ?></div></td>
