          ...
          <div class="col-lg-12">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-money"></i> 指导学生开题报告</h3>
              </div>
                  ...
                  <table class="table table-bordered table-hover table-striped tablesorter">
                    ...
                    <tbody>
                      <tbody>
                        ...
                        <td><div class="button-group"><?php if($vo["report"] != '' ): ?><div class="button-group"> <a class="button border-main" href="/index.php/Teacher/Presentation/downloadfile/path/<?php echo ($vo["report"]); ?>">  下载</a><?php else: ?>未上传<?php endif; ?></div></td>
