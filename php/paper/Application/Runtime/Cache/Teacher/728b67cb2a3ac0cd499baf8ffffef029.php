  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>查看<small>指导学生状态及成绩</small></h1>
            <ol class="breadcrumb">
              <li class="active"></li>
            </ol>
          ...
          <div class="col-lg-12">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-money"></i>  学生状态和成绩</h3>
              </div>
                  ...
                  <table class="table table-bordered table-hover table-striped tablesorter">
                    ...
                    <tbody>
                      <tbody>
                        ...
                        <td><?php if($vo['state'] == 1): ?>未选题<?php elseif($vo['state'] == 2): ?>选题已通过<?php elseif($vo['state'] == 3): ?>选题未通过<?php elseif($vo['state'] == 4): ?>已提交开题报告和开题PPT<?php elseif($vo['state'] == 5): ?>已提交论文和答辩PPT<?php endif; ?></td>
