    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
           ...
           <div class="col-lg-12">
            <h1>下载<small>指导学生答辩PPT</small> </h1>
            <ol class="breadcrumb">
              <li class="active"></li>
            </ol>
          ...
          <div class="col-lg-12">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-money"></i> 指导学生答辩PPT</h3>
              </div>
                ...
                <div class="table-responsive">
                  <table class="table table-bordered table-hover table-striped tablesorter">
                    ...
                    <tbody>
                      ...
                      <td><div class="button-group"> <?php if($vo["ppt2"] != '' ): ?><div class="button-group"> <a class="button border-main" href="/index.php/Teacher/Defense/downloadfile/path/<?php echo ($vo["ppt2"]); ?>">  下载</a><?php else: ?>未上传<?php endif; ?>
                         <!--  <a class="button border-main" href="/index.php/Teacher/Defense/add/id/<?php echo ($vo["id"]); ?>"> 上传</a> -->
