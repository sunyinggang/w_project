<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"D:\phpStudy\WWW\report\public/../application/admin\view\reward\index.html";i:1581934280;s:64:"D:\phpStudy\WWW\report\application\admin\view\public\header.html";i:1584188747;s:64:"D:\phpStudy\WWW\report\application\admin\view\public\footer.html";i:1486396310;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a class="btn btn-primary radius" href="<?php echo url('reward/add'); ?>"><i class="Hui-iconfont">&#xe600;</i> 添加悬赏公告信息</a></span> <span class="r"></span> </div>
...
<div class="mt-20">
	<table class="table table-border table-bordered table-bg table-hover table-sort">
		...
		<tr class="text-c">
			...
			<td class="td-manage">
				<a style="text-decoration:none" class="ml-5" href="<?php echo url('reward/edit',['id'=>$vo['id']]); ?>" title="修改"><i class="Hui-iconfont">&#xe6df;</i></a>
				<a style="text-decoration:none" class="ml-5" onClick="o2o_del('<?php echo url('reward/del',['id'=>$vo['id']]); ?>')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
			</td>
		</tr>
