<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\phpStudy\WWW\report\public/../application/admin\view\sort\index.html";i:1582968157;s:64:"D:\phpStudy\WWW\report\application\admin\view\public\header.html";i:1585894128;s:64:"D:\phpStudy\WWW\report\application\admin\view\public\footer.html";i:1486396310;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="cl pd-5 bg-1 bk-gray mt-20" style="margin-left: 30px;"> <span><?php echo $title; ?></span></div>
...
<div class="mt-20">
	<table class="table table-border table-bordered table-bg table-hover table-sort">
		...
		<tr class="text-c">
			...
			<?php endif; ?>
			<td class="td-manage">
				<a style="text-decoration:none" class="ml-5" href="<?php echo url('sort/edit',['sort_id'=>$vo['sort_id'],'id'=>$vo['id']]); ?>" title="审核"><i class="Hui-iconfont">&#xe6df;</i></a>
				<a style="text-decoration:none" class="ml-5" onClick="o2o_del('<?php echo url('sort/del',['sort_id'=>$vo['sort_id'],'id'=>$vo['id']]); ?>')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
			</td>
		</tr>
